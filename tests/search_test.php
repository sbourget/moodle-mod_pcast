...
class mod_pcast_search_testcase extends advanced_testcase {
    ...
    public function test_entries_access() {
        ...
        $teachernotapproved = self::getDataGenerator()->get_plugin_generator('mod_pcast')->create_content($pcast1, array('approved' => false));
        ...
        $studentnotapproved = self::getDataGenerator()->get_plugin_generator('mod_pcast')->create_content($pcast2, array('approved' => false));
