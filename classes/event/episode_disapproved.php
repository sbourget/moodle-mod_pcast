...
/**
 * The mod_pcast entry approved event.
 *
 * @package    mod_pcast
...
/**
 * The mod_pcast episode disapproved event class.
 *
 * @package    mod_pcast
 * @since      Moodle 2.7
 * @copyright  2014 Stephen Bourget
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class episode_disapproved extends \core\event\base {
    /**
     * Init method
     */
    ...
    public static function get_name() {
        return get_string('eventepisodedisapproved', 'mod_pcast');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has disapproved the podcast episode with id '$this->objectid' for " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'pcast', 'disapprove episode',
