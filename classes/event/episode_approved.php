 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class episode_approved extends \core\event\base {
    /**
     * Init method
     */
    ...
    public static function get_name() {
        return get_string('eventepisodeapproved', 'mod_pcast');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has approved the podcast episode with id '$this->objectid' for " .
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'pcast', 'approve episode',
