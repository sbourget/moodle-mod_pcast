 ...
 *
 * Triggered when the pcast episode ratings are viewed by a user.
 *
 * @package    mod_pcast
 * @since      Moodle 2.7
 * @copyright  2014 Stephen Bourget
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ratings_viewed extends \core\event\base {
    /**
     * Init method
     */
    ...
    public static function get_name() {
        return get_string('eventratingsviewed', 'mod_pcast');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed ratings for the podcast episode with id '$this->objectid' in " .
